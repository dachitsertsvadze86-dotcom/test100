    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <header className="bg-gradient-to-r from-primary via-secondary to-primary text-white shadow-xl">
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <p className="text-blue-100 text-lg">
            Customize your Toyota Supra with premium parts
          </p>
        </div>
      </header>
              ...
              <div className="mt-8 grid grid-cols-2 md:grid-cols-5 gap-3">
                {Object.keys(parts[selectedCarId] || {}).map((partType) => (
                  <button
                    ...
                    className="bg-gradient-to-r from-primary to-orange-600 hover:shadow-lg text-white font-semibold py-3 px-4 rounded-lg transition-all capitalize"
                  >
                    {partType}
                  </button>
                ))}
      ...
      <footer className="bg-gray-900 text-gray-400 py-8 mt-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p>© 2024 Car Customizer. All rights reserved.</p>
          <p className="mt-2 text-sm">Made with ❤️ for car enthusiasts</p>
        </div>
      </footer>
    </main>
  );
